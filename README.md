...
- `scripts/03_install_pwas.ps1` — Install PWAs (Notion, Discord, WhatsApp) via Chromium (Hibbiki.Chromium). Creates Start Menu shortcuts at `%APPDATA%\Microsoft\Windows\Start Menu\Programs\PWA\<App>.lnk`.
